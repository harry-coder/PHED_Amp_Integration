...
public class PaymentType extends AppCompatActivity implements LogoutListaner {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rdcash = (RadioButton)findViewById(R.id.RBCash);
        rdcheque =(RadioButton)findViewById(R.id.RBChe);
        spinner_indcident = (Spinner)findViewById(R.id.indcident);

        lloption = (LinearLayout) findViewById(R.id.lloptional);
        etCash = (EditText) findViewById(R.id.ETAmount);
//        etCash.setText(etCash.toString().replaceAll("^0+(?=\\d+$)",""));
        etBankName = (EditText) findViewById(R.id.ETBank);
        etChekNo = (EditText) findViewById(R.id.ETChNo);
        etMobNo = (EditText) findViewById(R.id.ETMobile);
        etDD = (EditText) findViewById(R.id.ETDDNo);
        etdemanddraft= (EditText)findViewById(R.id.ETDemadraftNo);
        etChekDate = (TextView) findViewById(R.id.ETDate);
        btnDate = (Button) findViewById(R.id.BTNDATE);
        btnPrint = (Button) findViewById(R.id.BTNPrint);
        spinner_BankName = (Spinner) findViewById(R.id.SPINNERBank);
//
...
//        }
        ...
        rgPaymentType = (RadioGroup) findViewById(R.id.RGType);
...
//        bank_name_id_list.clear();
        ...
        spinner_BankName.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view,
                ...
                str_bank_name = bank_name_list.get(position).toString();
                str_bank_name_id = bank_name_id_list.get(position).toString();
...
//                    customView = layoutInflater.inflate(R.layout.number_dialogue, null);
                    TextView txtamount = (TextView) customView.findViewById(R.id.amounttxt);
                    TextView txtview = (TextView) customView.findViewById(R.id.txt_amount);
                    Button btnno =(Button)customView.findViewById(R.id.btn_no);
                    Button btnyes =(Button)customView.findViewById(R.id.btn_yes);
