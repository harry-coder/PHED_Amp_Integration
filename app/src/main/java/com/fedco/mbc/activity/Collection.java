...
public class Collection extends AppCompatActivity implements LogoutListaner {
    ...
    public static DayEndReport dayEndReport;

    public static String cashNumber, cashAmount, chequeNumber, chequeAmount, ddNumber, ddAmount, totalCash, totalAmount;

    public static ArrayList <LastPrintEnergyPojo> energyList;

  public static  ArrayList<AmountClass> amountList;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        energyList = new ArrayList <LastPrintEnergyPojo> ( );
...
//            btnUBT.setEnabled(false);
    ...
    /*    SDActivity sdActivity=new SDActivity ();
        sdActivity.new LongOperationCol ().execute (  );
    */
        // new SDActivity ( ).new LongOperationCol ( ).execute ( );


        String isBankDetailsDownloaded = Paper.book ( ).read ( "isBankDetailsDownloaded" );

        if (isBankDetailsDownloaded == null) {
...
//                        R.anim.anim_slide_out_left);
              ...
              /*  String isBankDetailsDownloaded = Paper.book ( ).read ( "isBankDetailsDownloaded" );
                ...
                System.out.println ( "This is status " + isBankDetailsDownloaded );
                ...
                // set the custom dialog components - text, image and button
                final EditText editTextAccno = dialogAccount.findViewById ( R.id.EditTextACCno );
//                editTextAccno.setHint("Enter Account No./Meter No.");
//                editTextAccno.setInputType(InputType.TYPE_CLASS_NUMBER);
                RadioGroup rgPaymentType;
                rgPaymentType = dialogAccount.findViewById ( R.id.RGMode );
                final RadioButton rpre, rpos;
                int maxlength = 13;
//                editTextAccno.setFilters(new InputFilter[]{new InputFilter.LengthFilter(maxlength) { }});
                rpre = dialogAccount.findViewById ( R.id.RBpre );
                rpos = dialogAccount.findViewById ( R.id.RBpos );
                radiovaluepre = rpre.getText ( ).toString ( );
                radiovaluepos = rpos.getText ( ).toString ( );
                Button dialogButton = dialogAccount.findViewById ( R.id.dialogButtonACCnoOK );
                Button dHomeButton = dialogAccount.findViewById ( R.id.HomeButton );
...
//
        ...
        btnUBT.setOnClickListener ( new View.OnClickListener ( ) {
            ...
            public void onClick(View v) {
                ...
                dialogAccount.setTitle ( "Account Search" );
                // set the custom dialog components - text, image and button
                final EditText editTextAccno = dialogAccount.findViewById ( R.id.EditTextACC );
...
//                            public void onClick(SweetAlertDialog sDialog) {
                try {
                    ...
                    new  LastPrintReceiptRequest().execute (  );
                   /* dbHelper = new DB ( getApplicationContext ( ) );
                    SD = dbHelper.getWritableDatabase ( );
//                  String qweryDup = "SELECT * FROM TBL_COLMASTER_MP  WHERE REC_ID = (SELECT MAX(REC_ID)  FROM TBL_COLMASTER_MP)";
                    ...
                    Logger.e ( context, "COLMAS ", "query:" + sb.toString ( ) );
                ...
                try {
                    ...
                    if (cursorreport.getCount ( ) > 0 && cursorreport.moveToFirst ( ) && !cursorreport.getString ( 0 ).equals ( "NA" )) {
                        ...
                        do {
                            ...
                            System.out.println ( "This is the Name of Cashier " + _name );
...
//                }
        ...
        // System.out.println ("status downaload "+Paper.book ().read ( "isBankDetailsDownloaded" ) );
        /*if(isBankDetailsDownloaded!=null){
            if(!isBankDetailsDownloaded.equalsIgnoreCase ( "true" )){

                downloadBankDetailsDialog();
            }
        }*/
    ...
    public void downloadBankDetailsDialog() {
        ...
        sDialog.setTitleText ( "Download Bank Data First" );
    ...
    private class VerifyPassword extends AsyncTask <String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            if (curGetUser != null && curGetUser.moveToFirst ( )) {
                Logger.e ( context, "MainAct", "USER_ID" + curGetUser.getString ( 0 ) );
...
//                HttpFileUpload hfu = new HttpFileUpload("http://enservtest.fedco.co.in/MPSurvey/api/UploadFile/LogSessionMobile", "" + GSBilling.getInstance().getFinalZipName(), ".zip");
                Logger.e ( getApplicationContext ( ), "SLPrintAct", "http://enservtest.fedco.co.in/MPSurvey/api/UploadFile/LogSessionMobile" + GSBilling.getInstance ( ).getFinalZipName ( ) + ".zip" );
...
//to do fetch last receipotno from sqllite db collmast_mp table
                ...
                Logger.e ( context, "MainAct", URLS.VersionCode.meterno + codeIMEI + "/" + params[0] );
                Logger.e ( context, "MainAct", "para1 " + params[0] );
                try {
                    if (new CommonHttpConnection ( getApplicationContext ( ) ).isConnectingToInternet ( )) {
...
//            dismissProgressDialog();
            ...
            Logger.e ( context, "MainAct", "PostString " + s );
            if (s == null) {
                sDialog = new SweetAlertDialog ( Collection.this, SweetAlertDialog.ERROR_TYPE );
...
//                  Toast.makeText(Collection.this, "consumer not found", Toast.LENGTH_SHORT).show();
                    ...
                    try {
                        ...
                        System.out.println ("This is the response "+ja );
                        for (int i = 0; i < ja.length ( ); i++) {
                            JSONObject jsonSection = ja.getJSONObject ( i );



                            Logger.e ( context, "MainAct", "METERNO" + jsonSection.getString ( "METER_INST_FLAG" ) );
                            Logger.e ( context, "MainAct", "ARREARS" + jsonSection.getString ( "ARREAR" ) );
                            ...
                            for (int j = 0; j < innerJSON.length ( ); j++) {
                                ...
                                amountClass.setHeaed ( jsonobj.getString ( "HEAED" ) );
                                amountClass.setAmount ( jsonobj.getString ( "AMOUNT" ) );

                                System.out.println ("This is the amount "+jsonobj.getString ( "AMOUNT" ) );

                                amountList.add ( amountClass );
...
//              Toast.makeText(Collection.this, "InternetConnection Problem Try Again", Toast.LENGTH_SHORT).show();
    ...
    public class LongOperationCol extends AsyncTask <String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            // dbHelper4 = new DB(getApplicationContext());
            dbHelper5 = new DB ( Collection.this );

            SD3 = dbHelper5.getWritableDatabase ( );
        ...
        protected void onPostExecute(String result) {
            ...
            // sDialog.dismiss ( );
            new DownloadCollectionFileFromURL ( name, codeIMEI, Collection.this ).execute ( );
    ...
    public void requestServerSummary() {
        ...
        new DayEndRequest ( ).execute ( todayDate );


    }


    private class DayEndRequest extends AsyncTask <String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                System.out.println ( "This is the date " + params[0] );
               ...
               URL url = new URL ( URLS.CollectionData.collectionDayEnd + params[0] + "/" + "PH" + userId);
              //  URL url = new URL ( URLS.CollectionData.collectionDayEnd + params[0] + "/" + "PH0096" + MainActivity.MRID );
        ...
        protected void onPostExecute(String s) {
            ...
            if (s != null && !s.isEmpty ( ) && !s.equals ( " " )) {
                ...
                try {
                    ...
                    JSONObject reportObject = ja.getJSONObject ( 0 );


                    cashNumber = reportObject.getString ( "NOOFCASH" );
                    cashAmount = reportObject.getString ( "AMOUNTCASH" );

                    chequeNumber = reportObject.getString ( "NOOFCHEQUE" );
                    chequeAmount = reportObject.getString ( "AMOUNTCHEQUE" );

                    ddNumber = reportObject.getString ( "NOOFDD" );
                    ddAmount = reportObject.getString ( "AMOUNTDD" );

                    totalCash = reportObject.getString ( "TOTALCASH" );
                    totalAmount = reportObject.getString ( "TOTALAMOUNT" );
               ...
               /* if (s.trim ( ).equals ( "0" )) {
                ...
                Toast.makeText ( Collection.this, "Something went wrong try again!!", Toast.LENGTH_SHORT ).show ( );
    ...
    private class LastPrintReceiptRequest extends AsyncTask <String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                //URL url = new URL(URLS.UserAccess.userAuthenticate + codeIMEI + "&Uid=" + params[0] + "&Pass=" + params[1]);
                //URL url = new URL ( URLS.CollectionData.collectionSummary + "27-02-2019" + "/" + MainActivity.MR_id );
                URL url = new URL ( URLS.CollectionData.collectionLastReceipt + "PH" + userId );
               // URL url = new URL ( URLS.CollectionData.collectionLastReceipt + "PH0096"  );
    ...
    public void checkForConnectivity(){
        ...
        if(!checkInternetConnection ( this )){
            ...
            System.out.println ("Inside no connectivity" );
            ...
            TextView tv_tryAgain=dialog.findViewById ( R.id.tv_tryAgain );

            tv_tryAgain.setOnClickListener ( new View.OnClickListener ( ) {
                @Override
                public void onClick(View view) {

                    startActivityForResult(new Intent(android.provider.Settings.ACTION_SETTINGS), 1000);
...
*/
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == 1000 && resultCode == RESULT_OK) {
            System.out.println ("Inside this  result" );
            checkForConnectivity ();
        }
    }

    public void checkForCashier(){
