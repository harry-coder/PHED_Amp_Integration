 ...
 */
public class ConsumerSearchByMeterActivity extends Activity implements LogoutListaner{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_Header.setText("Search By Meter Number");
...
//                                        intent.putExtra("datalist", allist);
    ...
    public void userLogoutListaner() {
        finish();
        Intent intent=new Intent(ConsumerSearchByMeterActivity.this,MainActivity.class);
