 ...
 */
public class ConsumerSearchByAddressActivity extends Activity  implements LogoutListaner{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String ret = "select * from TBL_CONSMAST where address1 like '%" + str_cons_address + "%'";
...
//                                        intent.putExtra("datalist", allist);
    ...
    public void userLogoutListaner() {
        finish();
        Intent intent=new Intent(ConsumerSearchByAddressActivity.this,MainActivity.class);
