 ...
 */
public class UnzippingMeterFile extends AsyncTask<String, Integer, String> {

    String zipFile = Environment.getExternalStorageDirectory() + "/MBC/CED.zip";
    String unzipLocation = Environment.getExternalStorageDirectory() + "/unzippedmetfolder/";
...
//                    databasehelper = new DB(SDActivity.getsActivity());
                    databasehelper.insertIntoMeterTable(csvdata.get(t),SD );
                    try {
