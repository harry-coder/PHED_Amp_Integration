 ...
 */
public class UnzippingFile extends AsyncTask<String, Integer, String> {
    ...
    public UnzippingFile(String zipFileName) {
...
//                }
                ...
                switch (name_File) {
                    ...
                    /*case "mptariff.csv":
                        ...
                        BufferedReader buffertariff = new BufferedReader(file);

                        databasehelper = new DB(SDActivity.getsActivity());
                        SD3 = databasehelper.getWritableDatabase();
                        SD3.beginTransaction();

                        while ((line = buffertariff.readLine()) != null) {
                            //                    System.out.println("dddddddd" + line);
                            if (line != null) {
                    ...
                    */case "phedtariff.csv":
                        ...
                        BufferedReader bufferphedtariff = new BufferedReader(file);

                        databasehelper = new DB(SDActivity.getsActivity());
                        SD3 = databasehelper.getWritableDatabase();
                        SD3.beginTransaction();

                        while ((line = bufferphedtariff.readLine()) != null) {
                            //                    System.out.println("dddddddd" + line);
                            if (line != null) {

                                splitData = line.replace("'", "").split(Pattern.quote("}"));

                                databasehelper.insertBillPhedTRIFFMASTER(splitData, SD3);
