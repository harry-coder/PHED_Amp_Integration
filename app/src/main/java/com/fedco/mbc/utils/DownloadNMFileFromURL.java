 ...
 */
public class DownloadNMFileFromURL extends AsyncTask<String, String, String> implements OnCustomDialogClick{
...
//    static final String FTP_HOST = "103.192.172.42";
    ...
    private static final String LOCAL_PATH = "/MBC/NSC";
    private static final int BUFFER_SIZE = 4096;

    public DownloadNMFileFromURL(String zipFilename , String imeinum ){
...
//            conn = (HttpURLConnection) new URL("http://enserv.feedbackinfra.com/Webapi/api/DownloadZip/ZipDownloadCollectionFile?imieno=" + IMEInum).openConnection();
//            conn = (HttpURLConnection) new URL("http://enserv.feedbackinfra.com/Webapi_Testing/api/DownloadZip/ZipDownloadReadingSheet4NSCMR?imieno=" + IMEInum).openConnection();
            conn = (HttpURLConnection) new URL("http://enserv.feedbackinfra.com/Webapi/api/DownloadZip/ZipDownloadReadingSheet4NSCMR?imieno=" + IMEInum).openConnection();
        } catch (IOException e) {
            e.printStackTrace();
        }
