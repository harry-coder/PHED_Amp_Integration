 ...
 */
public class ConsumerSurvFileFromURL extends AsyncTask<String, String, String> implements OnCustomDialogClick {
    ...
    InputStream input;
    public ConsumerSurvFileFromURL(String zipFilename , String imeinum ){
...
//            conn = (HttpURLConnection) new URL(FTP_HOST).openConnection();
              conn = (HttpURLConnection) new URL("http://enservmp.fedco.co.in/MPSurvey/api/DownloadZip/ZipDownloadSurveyData?imieno=" + IMEInum).openConnection();
