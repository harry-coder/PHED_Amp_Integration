 ...
 */
 public class DownloadMeterFileFromURL extends AsyncTask<String, String, String> implements OnCustomDialogClick{
...
//    911504251717400
    ...
    public DownloadMeterFileFromURL(String zipFilename , String imeinum ){
...
//            conn = (HttpURLConnection) new URL(FTP_HOST).openConnection();
            conn = (HttpURLConnection) new URL("http://enserv.feedbackinfra.com/Webapi/api/DownloadZip/ZipDownloadReadingSheet?imieno=" + IMEInum).openConnection();
    ...
    protected void onPostExecute(String file_url) {
        ...
        if(!isDownloadCanceled) {
            if (mProgress == PROGRESS_COMPLETED) {
                new UnzippingMeterFile().execute();
