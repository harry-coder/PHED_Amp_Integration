 ...
 */
public class DownloadReplaceFileFromURL extends AsyncTask<String, String, String> implements OnCustomDialogClick {
    ...
    InputStream input;
    public DownloadReplaceFileFromURL(String zipFilename , String imeinum ){
...
//              conn = (HttpURLConnection) new URL("http://enserv.feedbackinfra.com/Webapi/api/DownloadZip/ZipDownload?imieno=" + IMEInum).openConnection();
              conn = (HttpURLConnection) new URL("http://enservmp.fedco.co.in/MPSurvey/api/DownloadZip/ZipDownloadBillingData?imieno=" + IMEInum).openConnection();
    ...
    protected void onPostExecute(String file_url) {
        ...
        if (!isDownloadCanceled) {
            if (mProgress == PROGRESS_COMPLETED) {
                mProgress = 0;
                // publishProgress(null);
                new UnzippingReplaceFile(name).execute();
