...
//            long updValue = session + 1;
    ...
    public void insertIntoColphedTable() {
        ...
        try {
            ...
            String columns = "DEV_ID , MR_NAME , MR_ID , CON_NO , COL_DATE , COL_TIME , RECIP_NO , CHEQ_NO , CHEQ_DATE , AMOUNT , BANK_NAME , MAN_BOOK_NO , " +
                    "MAN_RECP_NO , PYMNT_TYPE , INSTA_FLAG ,COL_DT, Upload_Flag  , USER_LONG , USER_LAT, BATERY_STAT, SIG_STRENGTH ," +
                    " MOB_NO, GPS_TIME, PRINTER_BAT, VER_CODE, USER_ALT, USER_ACCURACY,MBC_CONSUMPTION,TOTAL_CONSUMPTION," +
                    "APP1_CONSUMPTION,APP1_NAME,APP2_CONSUMPTION,APP2_NAME,APP3_CONSUMPTION,APP3_NAME," +
                    "CONS_NO_COPY,SESSIONID,MAIN_LINK_CONS_NO,LOC_CD,METER_NO,PAYMENT_TYPE,TOKEN_NO,PAYMENT_PURPOSE,ADDRESS," +
                    "CONS_NAME,UNITSACTAL,IBC,BSC,TARIFFCODE,TARIFF_RATE,TARIFF_INDEX,INCIDENT_TYPE";

            System.out.println ("This is the name "+GSBilling.getInstance().CONS_NAME );
            String name=""+GSBilling.getInstance().CONS_NAME;
...
//            String values = (Structcolmas.DEV_ID) + "','" + (Structcolmas.MR_NAME) + "','" + (Structcolmas.MR_ID) + "','" + (GSBilling.getInstance().ConsumerNO) + "','" + (Structcolmas.COL_DATE) + "','" + (Structcolmas.COL_TIME) + "','" + (Structcolmas.RECEIPT_NO) + "','" + (Structcolmas.CHEQUE_NO) + "','" + (Structcolmas.CH_DATE) + "','" + (Structcolmas.AMOUNT) + "','" + (Structcolmas.BANK_NAME) + "','" + (Structcolmas.MAN_BOOK_NO) + "','" + (Structcolmas.MAN_RECP_NO) + "','" + (Structcolmas.PYMNT_MODE) + "','" + (Structcolmas.INSTA_FLAG) + "','" + (Structcolmas.COL_DATE) + " " + (Structcolmas.COL_TIME) + "','" + (Structcolmas.UPLOAD_FLAG) + "','" + (Structcolmas.USER_LONG) + "','" + (Structcolmas.USER_LAT) + "','" + (Structcolmas.BAT_STATE) + "','" + (Structcolmas.SIG_STATE) + "','" + (Structcolmas.MOB_NO) + "','" + (Structcolmas.GPS_TIME) + "','" + (Structcolmas.PRNT_BAT_STAT) + "','" + (Structcolmas.VER_CODE) + "','" + (Structcolmas.GPS_ALTITUDE) + "','" + (Structcolmas.GPS_ACCURACY) + "','" + (Structcolmas.MBC_CONSUMPTION) + "','" + (Structcolmas.TOTAL_CONSUMPTION) + "','" + (Structcolmas.APP1_CONSUMPTION) + "','" + (Structcolmas.APP1_NAME) + "','" + (Structcolmas.APP2_CONSUMPTION) + "','" + (Structcolmas.APP2_NAME) + "','" + (Structcolmas.APP3_CONSUMPTION) + "','" + (Structcolmas.APP3_NAME) + "','" + (Structcolmas.CON_NO) + "','" + (Structcolmas.SESSION_KEY) + "','" + (Structcolmas.MAIN_LINK_CONS_NO) + "','" + (Structcolmas.LOC_CD);
            String values = (Structcolmas.DEV_ID) + "','" + (Structcolmas.MR_NAME) + "','" + (Structcolmas.MR_ID) + "','" + (GSBilling.getInstance().ConsumerNO) + "','" +
                    (GSBilling.getInstance().Serverdate) + "','" + (GSBilling.getInstance().Servertime) + "','" +
                    (GSBilling.getInstance().RecieptNo)+ "','"+(Structcolmas.CHEQUE_NO) + "','" + (Structcolmas.CH_DATE) + "','"
                    + (Structcolmas.AMOUNT) + "','"+(Structcolmas.BANK_NAME)+"','" + (Structcolmas.MAN_BOOK_NO) + "','"
                    + (GSBilling.getInstance().MANRECP_NO) + "','" + (Structcolmas.PYMNT_MODE) + "','"
                    + (Structcolmas.INSTA_FLAG) + "','" + (Structcolmas.COL_DATE) + " " + (Structcolmas.COL_TIME) + "','" + "N" + "','" +
                    (Structcolmas.USER_LONG) + "','" + (Structcolmas.USER_LAT) + "','" + (Structcolmas.BAT_STATE) + "','" +
                    (Structcolmas.SIG_STATE) + "','" + (Structcolmas.MOB_NO) + "','" + (Structcolmas.GPS_TIME) + "','" +
                    (Structcolmas.PRNT_BAT_STAT) + "','" + (Structcolmas.VER_CODE) + "','" + (Structcolmas.GPS_ALTITUDE) + "','"
                    + (Structcolmas.GPS_ACCURACY) + "','" + (Structcolmas.MBC_CONSUMPTION) + "','" + (Structcolmas.TOTAL_CONSUMPTION) + "','"
                    ...
                    + (GSBilling.getInstance().ConsumerNO) + "','" + (Structcolmas.SESSION_KEY) + "','" + (GSBilling.getInstance().ConsumerNO) + "','"
                    + (GSBilling.getInstance().SEC_CODE)+"','"+(GSBilling.getInstance().MeterNo)+"','"+(GSBilling.getInstance().Payment_type)+"','"
                    +(GSBilling.getInstance().TokenNo)+"','"+(GSBilling.getInstance().CON_TYPE+"','"+ GSBilling.getInstance().Addresses+"','"+ name+"','"+GSBilling.getInstance().punit)+"','"+GSBilling.getInstance().IBC +"','"+  GSBilling.getInstance().BSC +"','"+
                    GSBilling.getInstance().TARIFFCODE +"','"+ GSBilling.getInstance().TARIFF_RATE +"','"+ GSBilling.getInstance().TARIFF_INDEX +"','" + GSBilling.getInstance().INCIDENT_TYPE;
...
/*
            ...
            contentValues.put ( "DEV_ID",Structcolmas.DEV_ID );
            contentValues.put ( "MR_NAME",Structcolmas.MR_NAME );
            contentValues.put ( "MR_ID",Structcolmas.MR_ID );
            contentValues.put ( "CON_NO",GSBilling.getInstance().ConsumerNO);
            contentValues.put ( "COL_DATE",GSBilling.getInstance().Serverdate );
            contentValues.put ( "COL_TIME",GSBilling.getInstance().Servertime );
            contentValues.put ( "RECIP_NO",GSBilling.getInstance().RecieptNo );
            contentValues.put ( "CHEQ_NO",Structcolmas.CHEQUE_NO );
            contentValues.put ( "CHEQ_DATE",Structcolmas.CH_DATE );
            contentValues.put ( "AMOUNT",Structcolmas.AMOUNT );
            contentValues.put ( "BANK_NAME",Structcolmas.BANK_NAME );
            contentValues.put ( "MAN_BOOK_NO",Structcolmas.MAN_BOOK_NO );
            contentValues.put ( "MAN_RECP_NO",GSBilling.getInstance().MANRECP_NO );
            contentValues.put ( "PYMNT_TYPE",Structcolmas.PYMNT_MODE );
            contentValues.put ( "INSTA_FLAG",Structcolmas.INSTA_FLAG );
            contentValues.put ( "COL_DT",(Structcolmas.COL_DATE) + " " + (Structcolmas.COL_TIME) );
            contentValues.put ( "Upload_Flag","N" );
            contentValues.put ( "USER_LONG",Structcolmas.USER_LONG );
            contentValues.put ( "USER_LAT",Structcolmas.USER_LAT );
            contentValues.put ( "BATERY_STAT",Structcolmas.BAT_STATE );
            contentValues.put ( "SIG_STRENGTH",Structcolmas.SIG_STATE );
            contentValues.put ( "MOB_NO",Structcolmas.MOB_NO );
            contentValues.put ( "GPS_TIME",Structcolmas.GPS_TIME );
            contentValues.put ( "PRINTER_BAT",Structcolmas.PRNT_BAT_STAT );
            contentValues.put ( "VER_CODE",Structcolmas.VER_CODE );
            contentValues.put ( "USER_ALT",Structcolmas.GPS_ALTITUDE );
            contentValues.put ( "USER_ACCURACY",Structcolmas.GPS_ACCURACY );
            contentValues.put ( "MBC_CONSUMPTION",Structcolmas.MBC_CONSUMPTION );
            contentValues.put ( "TOTAL_CONSUMPTION",Structcolmas.TOTAL_CONSUMPTION );
            contentValues.put ( "APP1_CONSUMPTION",Structcolmas.APP1_CONSUMPTION );
            contentValues.put ( "APP1_NAME",Structcolmas.APP1_NAME );
            contentValues.put ( "APP2_CONSUMPTION",Structcolmas.APP2_CONSUMPTION );
            contentValues.put ( "APP2_NAME",Structcolmas.APP2_NAME );
            contentValues.put ( "APP3_CONSUMPTION",Structcolmas.APP3_CONSUMPTION );
            contentValues.put ( "APP3_NAME",Structcolmas.APP3_NAME );
            contentValues.put ( "CONS_NO_COPY",GSBilling.getInstance().ConsumerNO );
            contentValues.put ( "SESSIONID",Structcolmas.SESSION_KEY );
            contentValues.put ( "MAIN_LINK_CONS_NO",GSBilling.getInstance().ConsumerNO );
            contentValues.put ( "LOC_CD",GSBilling.getInstance().SEC_CODE );
            contentValues.put ( "METER_NO",GSBilling.getInstance().MeterNo );
            contentValues.put ( "PAYMENT_TYPE",GSBilling.getInstance().Payment_type );
            contentValues.put ( "TOKEN_NO",GSBilling.getInstance().TokenNo );
            contentValues.put ( "PAYMENT_PURPOSE",GSBilling.getInstance().CON_TYPE );
            contentValues.put ( "ADDRESS",GSBilling.getInstance().Addresses );
            contentValues.put ( "CONS_NAME",GSBilling.getInstance().CONS_NAME );
            contentValues.put ( "UNITSACTAL",GSBilling.getInstance().punit);
            contentValues.put ( "IBC",GSBilling.getInstance().IBC );
            contentValues.put ( "BSC",GSBilling.getInstance().BSC );
            contentValues.put ( "TARIFFCODE",GSBilling.getInstance().TARIFFCODE );
            contentValues.put ( "TARIFF_RATE",GSBilling.getInstance().TARIFF_RATE );
            contentValues.put ( "TARIFF_INDEX",GSBilling.getInstance().TARIFF_INDEX );
            contentValues.put ( "INCIDENT_TYPE",GSBilling.getInstance().INCIDENT_TYPE );
