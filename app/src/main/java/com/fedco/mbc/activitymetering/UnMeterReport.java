...
public class UnMeterReport extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.meternrreport);
        ...
        btn_filter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(divisionpre.length() !=0 && subdivisionpre.length() !=0 && sectionpre.length() ==14 && cyclepre.length() == 12)
                {
                    ...
                    String childQwery="SELECT * FROM TBL_METERMASTER WHERE CONSUMERNO NOT IN(SELECT CONSUMERNO  FROM TBL_METERUPLOAD) and DIVISION='"+divisionpre+"' and SUBDIVISION='"+subdivisionpre+"'";
                ...
                else if(divisionpre.length()!=0 && subdivisionpre.length()!=0 && sectionpre.length()!=14 && cyclepre.length() == 12)
                {
                    ...
                    String childQwery="SELECT * FROM TBL_METERMASTER WHERE CONSUMERNO NOT IN(SELECT CONSUMERNO  FROM TBL_METERUPLOAD) and DIVISION='"+divisionpre+"' and SUBDIVISION='"+subdivisionpre+"' and SECTION='"+sectionpre+"'";
                    filterSearch(SD,superQwery,childQwery);
                }// section empty
                else if(divisionpre.length()!=0 && subdivisionpre.length()!=0 && sectionpre.length()==14 && cyclepre.length() != 12)
                {
                    String superQwery="SELECT CONSUMERNO from TBL_METERMASTER WHERE DIVISION='"+divisionpre+"' and SUBDIVISION='"+subdivisionpre+"' and CYCLE='"+cyclepre+"'";
                    String childQwery="SELECT * FROM TBL_METERMASTER WHERE CONSUMERNO NOT IN(SELECT CONSUMERNO  FROM TBL_METERUPLOAD) and DIVISION='"+divisionpre+"' and SUBDIVISION='"+subdivisionpre+"' and CYCLE='"+cyclepre+"'";
                    filterSearch(SD,superQwery,childQwery);
                }//nothing empty
                else if(divisionpre.length()!=0 && subdivisionpre.length()!=0 && sectionpre.length()!=14 && cyclepre.length() != 12)
                {
                    ...
                    String childQwery="SELECT * FROM TBL_METERMASTER WHERE CONSUMERNO NOT IN(SELECT CONSUMERNO  FROM TBL_METERUPLOAD) and DIVISION='"+divisionpre+"' and SUBDIVISION='"+subdivisionpre+"' and SECTION='"+sectionpre+"' and CYCLE='"+cyclepre+"'";
                    section.length();
                    filterSearch(SD,superQwery,childQwery);
                }
                else
                {
                    Toast.makeText(UnMeterReport.this, "Please Check the filteration ", Toast.LENGTH_SHORT).show();
                }
        ...
        new Section(UnMeterReport.this).execute();
        new Cycle(UnMeterReport.this).execute();
        ...
        try {
            ...
            String total_c = "SELECT CONSUMERNO from TBL_METERMASTER WHERE DIVISION='"+divisionpre+"' and SUBDIVISION='"+subdivisionpre+"'";
            ...
            String ret = "SELECT * FROM TBL_METERMASTER WHERE CONSUMERNO NOT IN(SELECT CONSUMERNO  FROM TBL_METERUPLOAD) and DIVISION='"+divisionpre+"' and SUBDIVISION='"+subdivisionpre+"'";
            // String ret = "SELECT * FROM TBL_METERMASTER WHERE CONSUMERNO NOT IN(SELECT CONSUMERNO  FROM TBL_METERUPLOAD) and DIVISION='"+divisionpre+"' and SUBDIVISION='"+subdivisionpre+"' and SECTION='"+sectionpre+"' and CYCLE='"+cyclepre+"'";
    ...
    public void listSort(SQLiteDatabase SD ,CharSequence Filter){
        try {
            ...
            System.out.println("query---" + total_c);
            Cursor cursor_total = SD.rawQuery(total_c, null);
            Toast.makeText(getApplicationContext(), "Total Consumer:" + cursor_total.getCount(), Toast.LENGTH_LONG).show();
            t_count.setText("Total Consumer is: " + cursor_total.getCount());
            //for holding retrieve data from query and store in the form of rows
            String ret = "SELECT * FROM TBL_METERMASTER WHERE CONSUMERNO NOT IN(SELECT CONSUMERNO  FROM TBL_METERUPLOAD) and DIVISION='"+divisionpre+"' and SUBDIVISION='"+subdivisionpre+"' "+strWhereCondition+" ORDER BY "+Filter+" ASC";
            //  String ret = "SELECT * FROM TBL_METERMASTER WHERE CONSUMERNO NOT IN(SELECT CONSUMERNO  FROM TBL_METERUPLOAD) and DIVISION='"+divisionpre+"' and SUBDIVISION='"+subdivisionpre+"' and SECTION='"+sectionpre+"' and CYCLE='"+cyclepre+"' ORDER BY "+Filter+" ASC";
            System.out.println("query---" + ret);
            //Cursor curSearchdata = SD.rawQuery(ret, null);
            Cursor curSearchdata = SD.rawQuery(ret, null);
    ...
    public void filterSearch(SQLiteDatabase SD,String superQwer, String childQwer ){
        try {
            ...
            System.out.println("query---" + childQwer);
            //Cursor curSearchdata = SD.rawQuery(ret, null);
...
//        }
    ...
    public class Section extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            // ShowAlertagain();
            super.onPreExecute();
            pd = new ProgressDialog(UnMeterReport.this);
        ...
        protected String doInBackground(String... params) {
            ...
            databaseHelper = new DB(UnMeterReport.this);
