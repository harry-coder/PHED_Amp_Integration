...
public class MCReport extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.metermrreport);
        ...
        btn_filter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(divisionpre.length() !=0 && subdivisionpre.length() !=0 && sectionpre.length() ==14 && cyclepre.length() == 12)
                {
                    ...
                    String childQwery="SELECT * FROM TBL_METERMASTER  WHERE METER_REPLACE ='C' AND DIVISION='"+divisionpre+"' and SUBDIVISION='"+subdivisionpre+"'";
                ...
                else if(divisionpre.length()!=0 && subdivisionpre.length()!=0 && sectionpre.length()!=14 && cyclepre.length() == 12)
                {
                    ...
                    String childQwery="SELECT * FROM TBL_METERMASTER  WHERE METER_REPLACE ='C' AND DIVISION='"+divisionpre+"' and SUBDIVISION='"+subdivisionpre+"' and SECTION='"+sectionpre+"'";
                    filterSearch(SD,superQwery,childQwery);
                }
                else if(divisionpre.length()!=0 && subdivisionpre.length()!=0 && sectionpre.length()==14 && cyclepre.length() != 12)
                {
                    ...
                    String childQwery="SELECT * FROM TBL_METERMASTER  WHERE METER_REPLACE ='C' AND DIVISION='"+divisionpre+"' and SUBDIVISION='"+subdivisionpre+"' and CYCLE='"+cyclepre+"'";
                    filterSearch(SD,superQwery,childQwery);
                }
                else if(divisionpre.length()!=0 && subdivisionpre.length()!=0 && sectionpre.length()!=14 && cyclepre.length() != 12)
                {
                    String superQwery="SELECT CONSUMERNO from TBL_METERMASTER WHERE DIVISION='"+divisionpre+"' and SUBDIVISION='"+subdivisionpre+"' and SECTION='"+sectionpre+"' and CYCLE='"+cyclepre+"'";
                    String childQwery="SELECT * FROM TBL_METERMASTER  WHERE METER_REPLACE ='C' AND DIVISION='"+divisionpre+"' and SUBDIVISION='"+subdivisionpre+"' and SECTION='"+sectionpre+"' and CYCLE='"+cyclepre+"'";
                    section.length();
                    filterSearch(SD,superQwery,childQwery);
                }
                else
                {
                    Toast.makeText(MCReport.this, "Please Check the filteration ", Toast.LENGTH_SHORT).show();
                }
            }
        });
...
//                    intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
        ...
        try
        {
            ...
            Toast.makeText(getApplicationContext(), "Total Consumer:" + cursor_total.getCount(), Toast.LENGTH_SHORT).show();
            ...
            String ret = "select * from TBL_METERMASTER where METER_REPLACE ='C'and DIVISION='"+divisionpre+"' and SUBDIVISION='"+subdivisionpre+"' and SECTION='"+sectionpre+"' and CYCLE='"+cyclepre+"'";
            System.out.println("query---" + ret);
            Cursor curSearchdata = SD.rawQuery(ret, null);
            Toast.makeText(getApplicationContext(), "Total data Found:" + curSearchdata.getCount(), Toast.LENGTH_SHORT).show();
        ...
        {
            Toast.makeText(getApplicationContext(), "No data found"+e.getMessage(), Toast.LENGTH_SHORT).show();
        }
        ...
        new Section(MCReport.this).execute();
        new Cycle(MCReport.this).execute();
...
//            String total_c = "select CONSUMERNO from TBL_METERMASTER  where DIVISION='"+divisionpre+"' and SUBDIVISION='"+subdivisionpre+"' and SECTION='"+sectionpre+"' and CYCLE='"+cyclepre+"'";
            System.out.println("WERY "+superQwer);
...
//            String ret = "select CONSUMERNO from TBL_METERMASTER  where METER_REPLACE ='C''"+divisionpre+"' and SUBDIVISION='"+subdivisionpre+"' and SECTION='"+sectionpre+"' and CYCLE='"+cyclepre+"'";
//            System.out.println("query---" + ret);
            //Cursor curSearchdata = SD.rawQuery(ret, null);
    ...
    public void listSort(SQLiteDatabase SD ,CharSequence Filter){
        try {
            ...
            String total_c = "select CONSUMERNO from TBL_METERMASTER  where METER_REPLACE ='C' and DIVISION='"+divisionpre+"' and SUBDIVISION='"+subdivisionpre+"'"+strWhereCondition+"' ORDER BY "+Filter+" ASC";
            Cursor cursor_total = SD.rawQuery(total_c, null);
            Toast.makeText(getApplicationContext(), "Total Consumer:" + cursor_total.getCount(), Toast.LENGTH_SHORT).show();
            t_count.setText("Consumers : " + cursor_total.getCount());
            //for holding retrieve data from query and store in the form of rows
            String ret = "select * from TBL_METERMASTER where METER_REPLACE ='C'and DIVISION='"+divisionpre+"' and SUBDIVISION='"+subdivisionpre+"'"+strWhereCondition+"' ORDER BY "+Filter+" ASC";
            System.out.println("query---" + ret);
            //Cursor curSearchdata = SD.rawQuery(ret, null);
            Cursor curSearchdata = SD.rawQuery(ret, null);
    ...
    public class Section extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            // ShowAlertagain();
            super.onPreExecute();
            pd = new ProgressDialog(MCReport.this);
        ...
        protected String doInBackground(String... params) {
            ...
            databaseHelper = new DB(MCReport.this);
