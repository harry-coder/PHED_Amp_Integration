...
public class AllReplacedReport extends Activity {
    ...
    static final String[] letters = new String[]{
            ...
            "Cons No","IVRS No", "Name", "Meter No", "Address", "Cycle", "Route", "Divison", "Subdivision", "Section"};
...
//        });
        ...
        try {
            ...
            String ret = "select * from TBL_METER_REPLACEMENT where UPLOADFLAG ='Y'";
            ...
            c_count.setText("Replced Consumer is: " + curSearchdata.getCount());
