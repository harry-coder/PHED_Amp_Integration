...
public class CP2102SerialDevice extends UsbSerialDevice {
    ...
    public void setBaudRate(int baudRate) {
        setControlCommand(CP210x_SET_BAUDRATE, 0, new byte[]{(byte) (baudRate & 255), (byte) ((baudRate >> 8) & 255), (byte) ((baudRate >> 16) & 255), (byte) ((baudRate >> 24) & 255)});
    }
    ...
    private int setControlCommand(int request, int value, byte[] data) {
        ...
        int response = this.connection.controlTransfer(CP210x_REQTYPE_HOST2DEVICE, request, value, this.mInterface.getId(), data, dataLength, FTDISerialDevice.FTDI_BAUDRATE_600);
    ...
    private byte[] getCTL() {
        ...
        Log.i(CLASS_ID, "Control Transfer Response: " + String.valueOf(this.connection.controlTransfer(CP210x_REQTYPE_DEVICE2HOST, 4, 0, this.mInterface.getId(), data, data.length, FTDISerialDevice.FTDI_BAUDRATE_600)));
        return data;
    }
}
