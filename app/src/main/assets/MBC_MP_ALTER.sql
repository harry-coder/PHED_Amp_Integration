ALTER TABLE  "TBL_CONSUMERSURVEY_MASTER"  	ADD COLUMN   	"DTR_NAME" 		    TEXT DEFAULT NULL;
ALTER TABLE  "TBL_CONSUMERSURVEY_MASTER"  	ADD COLUMN   	"POLE_CODE" 		TEXT DEFAULT NULL;
ALTER TABLE  "TBL_CONSUMERSURVEY_MASTER"  	ADD COLUMN   	"METER_MAKE" 		TEXT DEFAULT NULL;
ALTER TABLE  "TBL_CONSUMERSURVEY_MASTER"  	ADD COLUMN   	"Mobile_Number" 	TEXT DEFAULT NULL;
ALTER TABLE  "TBL_CONSUMERSURVEY_MASTER"  	ADD COLUMN   	"EMAIL_ID" 			TEXT DEFAULT NULL;
ALTER TABLE  "TBL_CONSUMERSURVEY_UPOLOAD"  	ADD COLUMN   	"ADHAR" 	        TEXT DEFAULT NULL;
ALTER TABLE  "TBL_CONSUMERSURVEY_UPOLOAD"  	ADD COLUMN   	"MET_TYP" 	        TEXT DEFAULT NULL;
ALTER TABLE  "TBL_CONSUMERSURVEY_UPOLOAD"  	ADD COLUMN   	"MET_CAP" 	        TEXT DEFAULT NULL;
ALTER TABLE  "TBL_CONSUMERSURVEY_UPOLOAD"  	ADD COLUMN   	"MET_LOC" 	        TEXT DEFAULT NULL;

ALTER TABLE  "TBL_POLE_UPLOAD"  	        ADD COLUMN   	"CONDUCTER" 	    TEXT DEFAULT NULL;
ALTER TABLE  "TBL_POLE_UPLOAD"  	        ADD COLUMN   	"POLE_LOC" 	        TEXT DEFAULT NULL;
...
("ID " INTEGER PRIMARY KEY  AUTOINCREMENT  NOT NULL ,
 ...
 INSERT INTO "TBL_METERSTATUSCODE_MP" VALUES(4,'ASSESSED UNIT','4','ASU');
 INSERT INTO "TBL_METERSTATUSCODE_MP" VALUES(9,'METER REPLACED','9','MC');
 INSERT INTO "TBL_METERSTATUSCODE_MP" VALUES(10,'METER OVERFLOW','1','MC');
